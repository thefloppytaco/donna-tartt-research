...
**Subhead:** Published 10 years ago, 'The Secret History' was the most acclaimed first novel of the Nineties. But what happened to its author is an equally enthralling story. Boyd Tonkin reports on the strange case of Donna Tartt.
**Outlet:** The Independent (UK)
**Date:** 2002-05-21
**Author:** Boyd Tonkin
**Type:** Profile (does not include new interview material with Tartt — synthesizes prior interviews, publishing history, and reporting from those around her)
**Original URL (paywalled):** likely independent.co.uk/arts-entertainment/books/... — original slug not yet identified
**Source captured:** LIV reprint at https://www.languageisavirus.com/donna-tartt/interviews-whatever-happend-to.php · Portuguese-fan-archive mirror at https://arlindo-correia.com/081202.html
**Captured:** 2026-05

Resolves Section 5 holdout H03 (content captured; the canonical Independent URL is paywalled).

**Note:** Although categorized as a profile/article (not a sit-down interview), it's a primary biographical source because Tonkin had access to publisher contacts, includes new statements attributed to Tartt and to her UK publisher Alexandra Pringle, and is densely sourced with quoted material from her childhood essay "Sleepytown" and other places where Tartt speaks in her own voice.
...
- TSH manuscript length given here as 850 pages (vs. the 524-page final print and the page count Pat Lambert cited in 1992).
- Initial print run: 75,000 (huge for a first novel).
- Mother's family name: Boushé.
- "Old family mansion in Grenada, Mississippi" — the childhood home.
- Mother nickname "Baby" used by the great-aunts.
- TLF working title: "Tribulation."
- Bloomsbury (UK) advance for TLF: ~£1m.
- TSH manuscript was first sent to ICM (Binky Urban) by Bret Easton Ellis blind-date connection.
- Hanan al-Shaykh confirmed as a friend; introduces Tartt to painter Martin Johnson Heade.
- 2002 plan: a Canongate myth-retelling of Daedalus and Icarus (alongside Pullman, Atwood, Winterson, Coetzee). Note: this project does not appear to have been published.
- 1997 Mississippi classroom-killing connection — investigators looked at TSH as a possible influence.
- Confirms Ellis's *The Rules of Attraction* (1987) features a Tartt-like figure and the TSH plot before TSH was published.
- Public radio Halloween phone-in with Anne Rice (1997) reconfirmed.
- Confirms her childhood essay "Sleepytown" (Harper's, July 1992) as a primary source for the great-grandfather/whisky-and-codeine-syrup anecdote.
