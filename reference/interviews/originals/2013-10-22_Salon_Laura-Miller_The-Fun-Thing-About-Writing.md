...
**Outlet:** Salon
**Date:** Published 2013-10-22 (timestamped 11:00 PM EDT; Wikipedia gives 10-23)
**Interviewer:** Laura Miller
**Subhead:** Author of "The Secret History" on her new novel, Captain Kangaroo as Oprah, and the trouble with female characters
**Type:** Sit-down interview, in a Manhattan restaurant near Park Avenue
**Original URL:** https://www.salon.com/2013/10/22/donna_tartt_the_fun_thing_about_writing_a_book_is_that_it_really_is_a_different_life/
**Photo credit:** Beowulf Sheehan (Little, Brown and Company)
**Captured:** 2026-05 from live page
...
- Confirms "I've lived here [NYC] off and on since 1987" — places her in NY from age 23/24.
- Park Avenue as deliberate setting → grew from "a dark, spoiled Park Avenue mood. Park Avenue — but a bit off."
- The Goldfinch began "20 years ago in Amsterdam" — places conception at ~1993, right after TSH success in NL.
- Notebooks: "I keep notebooks and write in them all the time. I wrote a lot about Japan, for example, when I was there."
- "I live on a farm in Virginia part of the time" — Charlottesville reference.
- Used to check cellphone "once a week"; reception only "in a corner of the house" — degree of isolation.
- Childhood detail: Captain Kangaroo as her source for new-children's-book recommendations; Aunt Frances would buy them.
- Library in Grenada "built by the WPA and then they sort of stopped buying books" — explains the 19th-century reading diet.
- Editorial pushback against TSH narrator gender — same line told in QRR 2023 (P100), here with concrete editor anecdote.
- Confirms: "I've always had lots of male friends, close male friends" — directly addressing the male-perspective question.
- Self-portrait re. cinephilia: "I'll sit around and watch five Peter Lorre movies in a row."
- "Theo's take on things is not a million miles away from my own."
