...
**Date:** 2002-12-02
**Host:** John Ydstie (anchor)
**Reporter:** Martha Woodroof, WMRA (member station in Charlottesville, VA)
**Type:** Radio feature with recorded interview excerpts and a reviewer perspective (Daniel Mendelsohn, *The New Yorker*)
**Original URL:** NPR archive — canonical URL not preserved on LIV; NPR's standard storyId format suggests something like `npr.org/templates/story/story.php?storyId=…` (need to dig further)
**Source captured:** LIV reprint at https://www.languageisavirus.com/donna-tartt/interviews-the-little-friend-npr.php
**Captured:** 2026-05

Resolves Section 5 holdout H08. This is a **different** NPR appearance from R02 (Talk of the Nation w/ Lynn Neary, 2002-11-05) — *Morning Edition* with a reporter package by Martha Woodroof from WMRA Charlottesville, and a critic's voice from Daniel Mendelsohn of *The New Yorker*.
...
**Donna Tartt:** I thought that I needed to learn how to type and then I would be a writer. And it was a bitter, bitter disappointment to me when I was in high school and I learned that I could not compose at a typewriter. So I am still like a six-year-old dragging around these messy notebooks and lying on the floor and every once in a while losing the notebook. And — well, just like Medea, just sort of, you know, raging through the house, 'Where's my notebook? Where's my notebook?'
...
**Tartt:** The South in the '70s was an extremely interesting time because we were all looking around at each other and saying, 'Well, what do we do now? The old rules don't apply anymore.'
...
[Reads the famous "Harriet, the baby, was neither pretty nor sweet" passage from TLF.]
...
- **Handwriting, not typing**: Tartt explicitly says she cannot compose at a typewriter and writes by hand in notebooks — a process she's followed since age six. "Like Medea, just sort of, you know, raging through the house, 'Where's my notebook? Where's my notebook?'" Establishes her lifelong manual-composition workflow.
- "Ten years' worth of notebooks went into *The Little Friend*."
- Editing process described: rewrites a scene when she realizes "what was wrong with it was not the writing style. I was telling the scene from the point of view of the wrong character, so out it goes."
- Childhood criminology obsession: **Winnie Ruth Judd, the trunk murderess**, read about when "10 or 11"; Sherlock Holmes, especially "The Adventure of the Engineer's Thumb."
- **MLK assassination at age four** — fixed dating point (April 1968, age four → birth Dec 1963 confirms).
- Reporter Martha Woodroof works for WMRA, a member station serving the Shenandoah Valley — implies the interview was conducted in or near Charlottesville, VA, where Tartt has her farm.
- "Next big book… is still in the noodling phase" — December 2002 confirms TG (eventually 2013) was very early in its lifecycle then.
- The piece bundles a critical-reception clip from Daniel Mendelsohn (then writing for The New Yorker) — slightly mixed review.
