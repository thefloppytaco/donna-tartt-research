...
# True Grit (Bloomsbury 2005) - Tartt introduction

<sub>Introductions & Contributions · item `CON-001`</sub>

<img src="../assets/images/_retrieved/CON-001-truegrit-bloomsbury.jpg" alt="True Grit (Bloomsbury 2005) - Tartt introduction" width="280">
...
| Section | §7.1 |
| Edition | True Grit (Bloomsbury 2005) - Tartt introduction |
| Country | UK |
| Language | EN |
...
<sub>Full text reproduced for non-commercial research; original source linked above. Hosted at <code>assets/sources/fulltext/CON-001.md</code>.</sub>
